...
public class MobileGpsMainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ActivityMobileGpsMainBinding dataBinding =
        DataBindingUtil.setContentView(this, R.layout.activity_mobile_gps_main);
    gpsInfoViewModel =
    ...
    if (!Utils.hasUserGrantedNecessaryPermissions(this)) {
      Log.d(TAG, "Missing permission. Requesting all necessary permissions..." + ".");
    ...
    apiRadioGroup.setOnCheckedChangeListener(
        (RadioGroup group, int checkedId) -> {
          locationApiType =
              checkedId == R.id.m_radio_button_FLP
  ...
  final ServiceConnection gpsServiceConnection =
  ...
  private void switchToStopButton() {
    ...
    startAndStopButton.setBackground(getResources().getDrawable(R.drawable.mobile_button_red));
  }
  ...
  private void switchToStartButton() {
    ...
    startAndStopButton.setBackground(getResources().getDrawable(R.drawable.mobile_button_green));
  }
}
